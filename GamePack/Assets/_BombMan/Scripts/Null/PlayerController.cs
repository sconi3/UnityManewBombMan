...
public class PlayerController : MonoBehaviour
{
    ...
    void playerMove()
    {
        ...
        {
            rb2D.MovePosition((Vector2)transform.position + Vector2.up * speed * Time.deltaTime);
        ...
        {
            rb2D.MovePosition((Vector2)transform.position + Vector2.left * speed * Time.deltaTime);
        ...
        {
            rb2D.MovePosition((Vector2)transform.position + Vector2.right * speed * Time.deltaTime);
